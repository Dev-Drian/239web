<div id="basic-tab" class="tab-content p-6">
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div class="glass-dark rounded-2xl border border-white/15 p-6 backdrop-blur-xl">
            ...
            <div class="space-y-5">
                <div class="group">
                    <label for="name" class="block text-sm font-medium text-slate-300 mb-2 group-hover:text-blue-300 transition-colors duration-200">
                        Client Name*
                    </label>
                    <div class="relative">
                ...
                <div class="group">
                    <label for="email" class="block text-sm font-medium text-slate-300 mb-2 group-hover:text-blue-300 transition-colors duration-200">
                        Email Address*
                    </label>
                    <div class="relative">
                ...
                <div class="group">
                    <label for="website" class="block text-sm font-medium text-slate-300 mb-2 group-hover:text-blue-300 transition-colors duration-200">
                        Website
                    </label>
                    <div class="relative">
                ...
                <div class="group">
                    <label for="premium" class="block text-sm font-medium text-slate-300 mb-2 group-hover:text-blue-300 transition-colors duration-200">
                        Account Type
                    </label>
                    <div class="relative">
                        <select id="premium" name="premium"
                            ...
                            <option value="1" {{ $client->premium ? 'selected' : '' }} class="bg-slate-800 text-white">Premium</option>
                            <option value="0" {{ !$client->premium ? 'selected' : '' }} class="bg-slate-800 text-white">Standard</option>
                        </select>
                        <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                            <svg class="w-4 h-4 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
        ...
        <div class="glass-dark rounded-2xl border border-white/15 p-6 backdrop-blur-xl">
            ...
            <div class="space-y-5">
                <div class="group">
                    <label for="full_name" class="block text-sm font-medium text-slate-300 mb-2 group-hover:text-green-300 transition-colors duration-200">
                        Contact Name
                    </label>
                    <div class="relative">
                ...
                <div class="group">
                    <label for="phone" class="block text-sm font-medium text-slate-300 mb-2 group-hover:text-green-300 transition-colors duration-200">
                        Phone Number
                    </label>
                    <div class="relative">
                ...
                <div class="group">
                    <label for="address" class="block text-sm font-medium text-slate-300 mb-2 group-hover:text-green-300 transition-colors duration-200">
                        Address
                    </label>
                    <div class="relative">
                ...
                <div class="group">
                    <label for="city" class="block text-sm font-medium text-slate-300 mb-2 group-hover:text-green-300 transition-colors duration-200">
                        City
                    </label>
                    <div class="relative">
                        ...
                        <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                            <svg class="w-4 h-4 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-4m-5 0H9m0 0H5m0 0h2m0 0h4" />
                            </svg>
                        </div>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div class="group">
                        <label for="year_found" class="block text-sm font-medium text-slate-300 mb-2 group-hover:text-green-300 transition-colors duration-200">
                            Year Founded
                        </label>
                        <div class="relative">
                    ...
                    <div class="group">
                        <label for="employees" class="block text-sm font-medium text-slate-300 mb-2 group-hover:text-green-300 transition-colors duration-200">
                            Employees
                        </label>
                        <div class="relative">
