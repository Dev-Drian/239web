...
<div class="bg-white/95 backdrop-blur-sm p-4 flex items-center border-b border-gray-200 shadow-sm sticky top-0 z-10 transition-all duration-300">
    <!-- Avatar y Estado -->
    <div class="relative group">
        ...
        @else
            <div class="w-11 h-11 rounded-full bg-gradient-to-br from-indigo-500 to-indigo-600 text-white flex items-center justify-center mr-3 font-semibold transform transition-all duration-300 hover:scale-105 hover:shadow-lg">
    ...
    <div class="flex space-x-4 text-gray-500">
        {{-- <button class="hover:text-indigo-600 transition-colors" title="Menú">
