<x-app-layout>
    ...
    <script>
        ...
        function deleteImage(imageId, form) {
            const url = `{{ route('imageUser.delete', ':id') }}`.replace(':id', imageId); // Build the URL
            ...
            fetch(renameImageUrl, {
                ...
                .then(data => {
                    if (data.success) {
                        Swal.fire({
                            title: 'Renamed!',
                            text: 'The image has been successfully renamed.',
                            icon: 'success',
                            confirmButtonText: 'OK'
                        }).then(() => {
                            location.reload();
                        ...
                        Swal.fire({
                            title: 'Error',
                            text: data.message || 'Error renaming the image.',
                            icon: 'error',
                            confirmButtonText: 'OK'
                        });
                    }
                ...
                .catch(error => {
                    ...
                    Swal.fire({
                        title: 'Error',
                        text: 'An error occurred while renaming the image.',
                        icon: 'error',
                        confirmButtonText: 'OK'
                    });
                });
            ...
            imageGeneratorForm.addEventListener('submit', function(event) {
                ...
                .then(data => {
                    if (data.success) {
                        ...
                        Swal.fire({
                            title: 'Error',
                            text: data.message || 'Error generating image',
                            icon: 'error',
                            confirmButtonText: 'OK'
                        });
                    }
